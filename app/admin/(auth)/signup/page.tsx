...
export default function SignupPage(): JSX.Element {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      await axios.post(
        `${process.env.NEXT_PUBLIC_API_ENDPOINT}/auth/register-admin`,
        signupPayload
      );
          ...
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-xl bg-emerald-700 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-emerald-700/20 transition hover:bg-emerald-800 focus:outline-none focus:ring-4 focus:ring-emerald-200 disabled:cursor-not-allowed disabled:opacity-70"
              >
