...
function mapBackendErrorsToFields(messages: string[]): AdminFormErrors {
  ...
  messages.forEach((message) => {
    ...
    if (lowerMessage.includes("username") || lowerMessage.includes("uname")) {
      errors.uname = message;
      return;
    }
    ...
    if (
      lowerMessage.includes("name field") ||
      lowerMessage.includes("admin name") ||
...
export default function AdminsPage() {
  ...
  function validateForm() {
    ...
    if (!name) {
      ...
      errors.name = "Admin name should not contain any numbers.";
    }
    ...
    if (!password) {
      errors.password = editingAdminId
    ...
    if (socialMediaLinks && !isValidUrl(socialMediaLinks)) {
      errors.socialMediaLinks =
        "Please provide a valid URL. Example: https://facebook.com/username";
    }
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const backendFieldErrors = mapBackendErrorsToFields(messages);
        ...
        >
          ...
          <div>
            <input
              ...
              placeholder={
                editingAdminId ? "Password required for update" : "Password"
              }
              type="password"
              value={form.password}
                    ...
                    >
                      ...
                      <td className="px-5 py-4">
                        <div className="flex flex-wrap gap-2">
                          {adminId ? (
                            <Link
                              href={`/admin/dashboard/admins/${adminId}`}
